    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_status', models.CharField(choices=[('pending', 'Pending'), ('processing', 'Processing'), ('completed', 'Completed'), ('failed', 'Failed'), ('cancelled', 'Cancelled'), ('refunded', 'Refunded'), ('disputed', 'Disputed')], db_column='status', db_index=True, default='pending', max_length=20)),
        ...
        migrations.AddIndex(
            model_name='payment',
            index=models.Index(fields=['_status'], name='payments_pa_status_7ad4af_idx'),
        ),
        migrations.AddIndex(
            model_name='payment',
            index=models.Index(fields=['created'], name='payments_pa_created_708743_idx'),
        ),
        migrations.AddIndex(
            model_name='payment',
            index=models.Index(fields=['_status', 'created'], name='payments_pa_status_540537_idx'),
        ),
    ]
