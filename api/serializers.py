...
class UserProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserProfile
        fields = ('user', 'bio', 'profile_pic', 'profile_pic_url', 'social_links', 'phone', 'address')
...
class ServiceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Service
        fields = ('id', 'slug', 'name', 'category', 'short_desc', 'description', 
                 'price', 'image_url', 'avg_rating', 'review_count', 'is_active')
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = ('id', 'order_id', 'status', 'payment_status', 'customer_name', 
                 'customer_address', 'customer_phone', 'subtotal', 'tax', 'total', 
                 'items', 'created_at')
