# api/urls.py
# This file defines the URL routes for all API endpoints in the HomeSer backend.
# Each path maps a URL pattern to a specific view function or class,
# making the API accessible to the frontend and other clients.
...
urlpatterns = [
    ...
    path(
        "services/<int:id>/", views.ServiceDetailView.as_view(), name="service-detail"
    ),
    path(
