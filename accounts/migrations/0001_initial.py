...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('customer_type', models.CharField(choices=[('individual', 'Individual Customer'), ('business', 'Business Customer'), ('government', 'Government Customer')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_type', models.CharField(choices=[('individual', 'Individual Customer'), ('business', 'Business Customer'), ('government', 'Government Customer')], max_length=20)),
                ('email', models.EmailField(db_index=True, max_length=254, unique=True)),
                ('government_entity_name', models.CharField(db_index=True, max_length=150)),
                ('government_id', models.CharField(db_index=True, max_length=50, unique=True)),
                ('department', models.CharField(max_length=100)),
                ('contact_person', models.CharField(max_length=100)),
                ('entity_type', models.CharField(choices=[('federal', 'Federal'), ('state', 'State'), ('local', 'Local'), ('other', 'Other')], max_length=50)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_applied', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=5)),
            ...
            options={
                ...
                'ordering': ['-created'],
                'indexes': [models.Index(fields=['content_type', 'object_id'], name='accounts_cu_content_a8f872_idx'), models.Index(fields=['created', 'content_type', 'object_id'], name='accounts_cu_created_930c8f_idx')],
            },
        ),
    ]
